...
<script type="text/javascript">
	function checkForm() {
		...
		joinform.action = "insertMember.do";
		joinform.submit();
	}
...
<article>
	...
	<table class="buyForm">
		<tr>
			<td width="150px">아이디<font color="red">*</font></td>
			<td width="900px"><input type="text" name="id" autofocus></td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="address" id="address"> 기본주소<br>
		...
		<tr>
			<td>SMS 수신여부<font color="red">*</font>
			<td>
				<input type="checkbox" name="sms">동의함 <input type="checkbox">동의하지 않음<br>
		...
		<tr>
			...
			<td>
				...
				<p>- 회원정보 분실시 이메일을 통해 본인확인을 진행합니다.<br>
				- 이메일 주소란에는 반드시 수신가능한 이메일주소를 입력해 주세요</p>
			</td>
		</tr>
	
		<tr>
			<td>Email 수신여부<font color="red">*</font>
			<td>
				<input type="checkbox" name="sms">동의함 <input type="checkbox">동의하지 않음<br>
				<p>쇼핑몰에서 제공하는 유익한 이벤트 소식을 Email로 받으실 수 있습니다.</p>
			</td>
		</tr>
	</table>
	<div>
		<p><b>이용약관 동의</b></p>
		<textarea cols="140" rows="10">제1조(목적)
이 약관은 오스퀘어 회사(전자상거래 사업자)가 운영하는 집꾸미기 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란 오스퀘어 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
② “이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
③ ‘회원’이라 함은 “몰”에 (삭제) 회원등록을 한 자로서, 계속적으로 “몰”이 제공하는 서비스를 이용할 수 있는 자를 말합니다.
④ ‘비회원’이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.

제3조 (약관 등의 명시와 설명 및 개정)
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 집꾸미기 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다. 
		...
		<p>이용약관에 동의하십니까?<input type="checkbox">동의함 <input type="checkbox">동의하지 않음</p>
	</div>
	<br>
	<br>
	<div>
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
	...
	<hr>
	<br>
	<input type="button" value="회원가입" class="join_submit" onclick="checkForm()">
	<input type="button" value="회원가입 취소" class="join_button" onclick="history.go(-1)">
	</form>
	</div>
</article>
